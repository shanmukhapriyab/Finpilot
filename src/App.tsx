    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <div className="page-content">
          <section className="welcome-row"><div><p className="eyebrow">SATURDAY, SEPTEMBER 20, 2026</p><h1>Good morning, Alex <span className="wave">✦</span></h1><p className="muted">Here’s your financial pulse at a glance.</p></div><button className="upload-btn"><UploadCloud size={17} /> Upload data</button></section>
          ...
          <section className="bottom-grid"><article className="assistant-banner"><div className="assistant-icon"><Bot size={22} /></div><div><p className="eyebrow">FINPILOT INSIGHT</p><h2>You’re building a healthy buffer.</h2><p>Your spending is on track this month. You have <strong>₹9,430</strong> safe to spend before your next paycheck.</p></div><button className="dark-outline-btn">Ask FinPilot <ArrowUpRight size={15} /></button></article><article className="upload-panel"><div className="upload-icon"><FileUp size={20} /></div><div><h3>Bring in your latest data</h3><p>Upload a CSV, PDF or bank statement.</p></div><button className="small-upload" aria-label="Upload file"><UploadCloud size={17} /></button></article></section>
